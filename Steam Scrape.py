...
# # Final Scrape!
# 
# We had trouble finding a way to get All-Time population count from the Official Steam Store page
# 
# So, as a 'heuristic' we instead use the All-Time Review counts. We feel that this can work, since bigger games will have a lot more reviews than smaller games.
# 
# For example, a triple-A game like Destiny 2 has 468k reviews, while an indie game like Maneater has only 6k reviews.
# 
# After some additions to the code, we finally can scrape more info about the games and conduct a more thorough analysis
# 
# 

# %% [markdown]
# Also, we managed to get a larger list of steam links (~4,000 links this time)
# 
# Import
...
hw_df.to_csv('steam_hardware_data_v5.csv')

# %%
import pandas as pd

# Fully cleaned data
data = pd.read_csv("/content/Steam Hardwared Data Fully Cleaned - Steam Data Clean V5 (Cleaned - Empty Hardware Data Trimmed).csv")
...
# %%
# Baseline?
data.plot(x='Original Price', y='Total Count of Reviews', style='o')
